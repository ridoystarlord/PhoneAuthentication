...
public class LoginOTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        box=findViewById(R.id.otpbox);

        sentOTPCode(mobile);
        btn_Verifyotp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                verifyOTPCode(box.getText().toString());
        ...
        auth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(LoginOTPActivity.this, "Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        PhoneAuthOptions options= PhoneAuthOptions.newBuilder()
                ...
                .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        dialog.dismiss();
                        Toast.makeText(LoginOTPActivity.this, "OTP Sent Error"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
